...
function custom_post_example() { 
	...
	register_post_type( 'slider', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array('labels' => array(
			'name' => __('Image Slider', 'post type general name'), /* This is the Title of the Group */
			'singular_name' => __('Image Slide', 'post type singular name'), /* This is the individual type */
			'add_new' => __('Add Image', 'custom post type item'), /* The add new menu item */
			'add_new_item' => __('Add Slide'), /* Add New Display Title */
			'edit' => __( 'Edit' ), /* Edit Dialog */
			'edit_item' => __('Edit Slide'), /* Edit Display Title */
			'new_item' => __('New Image Slide'), /* New Display Title */
			'view_item' => __('View Image Slide'), /* View Display Title */
			'search_items' => __('Search Slides'), /* Search Custom Type Title */ 
			'not_found' =>  __('Nothing found in the Database.'), /* This displays if there are no entries yet */ 
			'not_found_in_trash' => __('Nothing found in Trash'), /* This displays if there is nothing in the trash */
			'parent_item_colon' => ''
			), /* end of arrays */
			'description' => __( 'This is to add images to the home page slider' ), /* Custom Type Description */
			'public' => true,
